...
| Wave 3 | [#4](https://github.com/ifuschini/idelium-api-go/issues/4) | In progress | Platform type reads moved to Go ownership; `d4b7f22 feat: add read-only platform catalogs` |
