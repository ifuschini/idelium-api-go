...
| `accounts` | go | 4 | 3 | 4 | laravel-primary |
| `agent-registry` | go | 3 | 2 | 2 | laravel-primary |
| `artifacts` | go | 7 | 4 | 7 | laravel-primary |
| `asset-versions` | go | 5 | 1 | 5 | laravel-primary |
...
| `customers` | go | 6 | 4 | 6 | laravel-primary |
| `enterprise-identity` | go | 9 | 8 | 5 | laravel-primary |
| `environments` | go | 7 | 3 | 5 | laravel-primary |
| `execution-results` | none | 3 | 0 | 3 | laravel-primary |
| `grid-jobs` | go | 4 | 2 | 4 | laravel-primary |
| `integrations` | go | 7 | 5 | 7 | laravel-primary |
...
| `plugins` | go | 7 | 3 | 5 | laravel-primary |
| `projects` | go | 7 | 3 | 7 | laravel-primary |
| `result-exports` | go | 3 | 1 | 3 | laravel-primary |
| `service-accounts` | go | 3 | 2 | 3 | laravel-primary |
| `steps` | go | 7 | 4 | 6 | laravel-primary |
| `test-cycles` | go | 5 | 2 | 4 | laravel-primary |
| `test-launches` | laravel | 1 | 1 | 1 | laravel-primary |
| `tests` | go | 6 | 3 | 5 | laravel-primary |
...
| `GET|HEAD` | `/api/admin/accounts` | `accounts` | read | go | yes | 9 |
| `POST` | `/api/admin/accounts` | `accounts` | mutation | go | yes | 9 |
| `DELETE` | `/api/admin/accounts/{idUser}` | `accounts` | mutation | go | yes | 9 |
| `PUT` | `/api/admin/accounts/{idUser}` | `accounts` | mutation | go | yes | 9 |
| `GET|HEAD` | `/api/admin/agents` | `agent-registry` | read | go | yes | 8 |
| `PUT` | `/api/admin/agents/{agentRegistration}/status` | `agent-registry` | mutation | go | yes | 8 |
| `GET|HEAD` | `/api/admin/apikey` | `legacy-api-keys` | read | go | yes | 9 |
| `PUT` | `/api/admin/apikey` | `legacy-api-keys` | mutation | go | yes | 9 |
| `GET|HEAD` | `/api/admin/costumers` | `customers` | read | go | yes | 9 |
| `POST` | `/api/admin/costumers` | `customers` | mutation | go | yes | 9 |
| `DELETE` | `/api/admin/costumers/{idCostumer}` | `customers` | mutation | go | yes | 9 |
| `PUT` | `/api/admin/costumers/{idCostumer}` | `customers` | mutation | go | yes | 9 |
| `POST` | `/api/admin/environments` | `environments` | mutation | go | yes | 6 |
| `GET|HEAD` | `/api/admin/environments/{idProject}` | `environments` | read | go | yes | 6 |
| `DELETE` | `/api/admin/environments/{idProject}/{environment}` | `environments` | mutation | go | yes | 6 |
| `GET|HEAD` | `/api/admin/environments/{idProject}/{environment}` | `environments` | read | go | yes | 6 |
| `PUT` | `/api/admin/environments/{idProject}/{environment}` | `environments` | mutation | go | yes | 6 |
| `POST` | `/api/admin/grid/bulk-jobs` | `grid-jobs` | mutation | go | yes | 7 |
| `GET|HEAD` | `/api/admin/grid/bulk-jobs/{jobId}` | `grid-jobs` | read | go | yes | 7 |
| `GET|HEAD` | `/api/admin/grid/bulk-jobs/{jobId}/export` | `grid-jobs` | read | go | yes | 7 |
| `POST` | `/api/admin/grid/query-snapshots` | `grid-jobs` | mutation | go | yes | 7 |
...
| `POST` | `/api/admin/importtest` | `tests` | mutation | go | yes | 6 |
...
| `POST` | `/api/admin/plugins` | `plugins` | mutation | go | yes | 6 |
| `GET|HEAD` | `/api/admin/plugins/{idProject}` | `plugins` | read | go | yes | 6 |
| `DELETE` | `/api/admin/plugins/{idProject}/{plugin}` | `plugins` | mutation | go | yes | 6 |
| `GET|HEAD` | `/api/admin/plugins/{idProject}/{plugin}` | `plugins` | read | go | yes | 6 |
| `PUT` | `/api/admin/plugins/{idProject}/{step}` | `plugins` | mutation | go | yes | 6 |
...
| `GET|HEAD` | `/api/admin/projects` | `projects` | read | go | yes | 6 |
| `POST` | `/api/admin/projects` | `projects` | mutation | go | yes | 6 |
| `GET|HEAD` | `/api/admin/projects/create` | `projects` | read | go | yes | 6 |
| `GET|HEAD` | `/api/admin/projects/{idProject}/asset-impact/{assetType}/{assetId}` | `asset-versions` | read | go | yes | 7 |
| `GET|HEAD` | `/api/admin/projects/{idProject}/asset-versions/{assetType}/{assetId}` | `asset-versions` | read | go | yes | 7 |
| `GET|HEAD` | `/api/admin/projects/{idProject}/asset-versions/{assetVersion}` | `asset-versions` | read | go | yes | 7 |
| `POST` | `/api/admin/projects/{idProject}/asset-versions/{assetVersion}/review-events` | `asset-versions` | mutation | go | yes | 7 |
| `GET|HEAD` | `/api/admin/projects/{idProject}/asset-versions/{fromVersion}/diff/{toVersion}` | `asset-versions` | read | go | yes | 7 |
| `GET|HEAD` | `/api/admin/projects/{idProject}/integration-deliveries` | `integrations` | read | go | yes | 7 |
| `POST` | `/api/admin/projects/{idProject}/integration-deliveries/{integrationDelivery}/replay` | `integrations` | mutation | go | yes | 7 |
| `GET|HEAD` | `/api/admin/projects/{idProject}/integrations` | `integrations` | read | go | yes | 7 |
| `POST` | `/api/admin/projects/{idProject}/integrations` | `integrations` | mutation | go | yes | 7 |
| `POST` | `/api/admin/projects/{idProject}/integrations/{integrationEndpoint}/rotate-secret` | `integrations` | mutation | go | yes | 7 |
| `PUT` | `/api/admin/projects/{idProject}/integrations/{integrationEndpoint}/status` | `integrations` | mutation | go | yes | 7 |
| `POST` | `/api/admin/projects/{idProject}/integrations/{integrationEndpoint}/test` | `integrations` | mutation | go | yes | 7 |
...
| `GET|HEAD` | `/api/admin/projects/{idProject}/performed-test-cycles/{performedTestCycleId}/artifacts` | `artifacts` | read | go | yes | 7 |
| `GET|HEAD` | `/api/admin/projects/{idProject}/performed-test-cycles/{performedTestCycleId}/artifacts/{artifactDescriptor}` | `artifacts` | read | go | yes | 7 |
| `POST` | `/api/admin/projects/{idProject}/performed-test-cycles/{performedTestCycleId}/artifacts/{artifactDescriptor}/archive` | `artifacts` | mutation | go | yes | 7 |
| `POST` | `/api/admin/projects/{idProject}/performed-test-cycles/{performedTestCycleId}/artifacts/{artifactDescriptor}/delete-marker` | `artifacts` | mutation | go | yes | 7 |
| `GET|HEAD` | `/api/admin/projects/{idProject}/performed-test-cycles/{performedTestCycleId}/artifacts/{artifactDescriptor}/impact` | `artifacts` | read | go | yes | 7 |
| `PUT` | `/api/admin/projects/{idProject}/performed-test-cycles/{performedTestCycleId}/artifacts/{artifactDescriptor}/legal-hold` | `artifacts` | mutation | go | yes | 7 |
| `POST` | `/api/admin/projects/{idProject}/performed-test-cycles/{performedTestCycleId}/artifacts/{artifactDescriptor}/restore` | `artifacts` | mutation | go | yes | 7 |
| `DELETE` | `/api/admin/projects/{project}` | `projects` | mutation | go | yes | 6 |
| `GET|HEAD` | `/api/admin/projects/{project}` | `projects` | read | go | yes | 6 |
| `PUT|PATCH` | `/api/admin/projects/{project}` | `projects` | mutation | go | yes | 6 |
| `GET|HEAD` | `/api/admin/projects/{project}/edit` | `projects` | read | go | yes | 6 |
| `POST` | `/api/admin/result-exports` | `result-exports` | mutation | go | yes | 7 |
| `GET|HEAD` | `/api/admin/result-exports/{resultExport}` | `result-exports` | read | go | yes | 7 |
| `GET|HEAD` | `/api/admin/result-exports/{resultExport}/download` | `result-exports` | read | go | yes | 7 |
| `GET|HEAD` | `/api/admin/roles` | `access-control` | read | go | yes | 9 |
...
| `POST` | `/api/admin/steps` | `steps` | mutation | go | yes | 6 |
| `GET|HEAD` | `/api/admin/steps/{idProject}` | `steps` | read | go | yes | 6 |
| `POST` | `/api/admin/steps/{idProject}/updateorder` | `steps` | mutation | go | yes | 6 |
| `DELETE` | `/api/admin/steps/{idProject}/{environment}` | `steps` | mutation | go | yes | 6 |
| `GET|HEAD` | `/api/admin/steps/{idProject}/{step}` | `steps` | read | go | yes | 6 |
| `PUT` | `/api/admin/steps/{idProject}/{step}` | `steps` | mutation | go | yes | 6 |
| `GET|HEAD` | `/api/admin/stepsperfomed/{idTestPerformed}` | `execution-results` | read | go | yes | 7 |
| `POST` | `/api/admin/testcycles` | `test-cycles` | mutation | go | yes | 6 |
| `GET|HEAD` | `/api/admin/testcycles/{idProject}` | `test-cycles` | read | go | yes | 6 |
| `GET|HEAD` | `/api/admin/testcycles/{idProject}/{testcycle}` | `test-cycles` | read | go | yes | 6 |
| `PUT` | `/api/admin/testcycles/{idProject}/{testcycle}` | `test-cycles` | mutation | go | yes | 6 |
| `GET|HEAD` | `/api/admin/testcyclesperfomed/{idTestCyclePerformed}` | `execution-results` | read | go | yes | 7 |
| `POST` | `/api/admin/tests` | `tests` | mutation | go | yes | 6 |
| `GET|HEAD` | `/api/admin/tests/{idProject}` | `tests` | read | go | yes | 6 |
| `GET|HEAD` | `/api/admin/tests/{idProject}/{test}` | `tests` | read | go | yes | 6 |
| `PUT` | `/api/admin/tests/{idProject}/{test}` | `tests` | mutation | go | yes | 6 |
| `GET|HEAD` | `/api/admin/testsperfomed/{idTestPerformed}` | `execution-results` | read | go | yes | 7 |
| `GET|HEAD` | `/api/audit-events` | `audit-events` | read | go | yes | 9 |
| `GET|HEAD` | `/api/clear` | `operations` | read | laravel | no | 0 |
| `GET|HEAD` | `/api/csrf-cookie` | `operations` | read | go | no | 0 |
| `POST` | `/api/ideliumcl/agents/register` | `agent-registry` | mutation | go | no | 8 |
| `GET|HEAD` | `/api/ideliumcl/environment/{idEnvironment}` | `environments` | read | go | no | 4 |
...
| `GET|HEAD` | `/api/me/capabilities` | `access-control` | read | go | yes | 9 |
| `GET|HEAD` | `/api/menu/header` | `customers` | read | go | yes | 9 |
| `PUT` | `/api/menu/header/{idCostumer}` | `customers` | mutation | go | yes | 9 |
| `GET|HEAD` | `/api/menu/sidebar` | `access-control` | read | go | yes | 9 |
| `POST` | `/api/oidc/token-exchange` | `enterprise-identity` | mutation | go | no | 9 |
| `GET|HEAD` | `/api/sanctum/csrf-cookie` | `operations` | read | go | no | 9 |
