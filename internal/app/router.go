...
func NewRouter(
	...
	router.Get("/csrf-cookie", browserAuthHandler.CSRF)
	...
	router.Get("/admin/environments/{idProject}", browserAuthHandler.Environments)
	router.Get("/admin/environments/{idProject}/{environment}", browserAuthHandler.ShowEnvironment)
	...
	router.Post("/admin/plugins", browserAuthHandler.CreatePlugin)
	router.Put("/admin/plugins/{idProject}/{plugin}", browserAuthHandler.UpdatePlugin)
	router.Delete("/admin/plugins/{idProject}/{plugin}", browserAuthHandler.DeletePlugin)
	...
	router.Post("/admin/launchtest", browserAuthHandler.LaunchTest)
	...
	router.Get("/admin/projects/{idProject}/parallel-runs/{parallelRun}/results", browserAuthHandler.Results)
	router.Put("/admin/projects/{idProject}/parallel-runs/{parallelRun}/workers/{workerId}", browserAuthHandler.UpdateParallelRunWorker)
	...
	platformHandler := platforms.NewHandler(catalogRepository, logger, browserAuthRepository)
	...
	router.Post("/admin/platforms/brands", platformHandler.CreateBrand)
	router.Put("/admin/platforms/brands", platformHandler.UpdateBrand)
	router.Post("/admin/platforms/browsers", platformHandler.CreateBrowser)
	router.Put("/admin/platforms/browsers", platformHandler.UpdateBrowser)
	router.Post("/admin/platforms/browserversions", platformHandler.CreateBrowserVersion)
	router.Put("/admin/platforms/browserversions", platformHandler.UpdateBrowserVersion)
	router.Post("/admin/platforms/locations", platformHandler.CreateLocation)
	router.Put("/admin/platforms/locations", platformHandler.UpdateLocation)
	router.Post("/admin/platforms/manageplatforms", platformHandler.CreateManagedPlatform)
	router.Put("/admin/platforms/manageplatforms", platformHandler.UpdateManagedPlatform)
	router.Delete("/admin/platforms/manageplatforms/{type}/{id}", platformHandler.DeleteManagedPlatform)
	router.Post("/admin/platforms/models", platformHandler.CreateModel)
	router.Put("/admin/platforms/models", platformHandler.UpdateModel)
	router.Post("/admin/platforms/os", platformHandler.CreateOperatingSystem)
	router.Put("/admin/platforms/os", platformHandler.UpdateOperatingSystem)
	router.Post("/admin/platforms/osversion", platformHandler.CreateOperatingSystemVersion)
	router.Put("/admin/platforms/osversion", platformHandler.UpdateOperatingSystemVersion)
	...
	router.Put("/admin/identity/providers/{identityProvider}/scim/users/{user}", identityHandler.SCIMUsers)
	router.Patch("/admin/identity/providers/{identityProvider}/scim/users/{user}", identityHandler.SCIMUsers)
	router.Delete("/admin/identity/providers/{identityProvider}/scim/users/{user}", identityHandler.SCIMUsers)
	...
	router.Group(func(router chi.Router) {
		...
		router.Get("/ideliumcl/projects/{idProject}/parallel-runs/{parallelRun}/results", browserAuthHandler.CLResults)
		router.Put("/ideliumcl/projects/{idProject}/parallel-runs/{parallelRun}/workers/{workerId}", browserAuthHandler.CLUpdateParallelRunWorker)
